...
module.exports.data = [
  ...
  */
  ...
  {name: 'ferric sodium gluconate', sizePrices: ['62.5/31.80']}, // ferric sodium gluconate complex  NOTE DONE; // ferric sodium gluconate complex  NOTE DONE; Brand is 'ferrlecit' according to pdf, but ferrlecit not present in excel sheet; advised to change name to generic

  {name: 'feraheme', sizePrices: ['510/734.40']}, // ferumoxytol NOTE DONE
  {name: 'fluorouracil', sizePrices: ['500/1.99', '2500/7.79']}, // no brand NOTE DONE
  ...
  {name: 'oncovin', sizePrices: ['1/5.38', '2/10.00']}, //vincristine NOTE DONE; used pricing for vincasar per email
  ...
  /*
    these are te prices from the email on January 11, 2018
  */
  ...
  */
  ...
  {name: 'hemin', sizePrices: ['350/7448.50']}
]
